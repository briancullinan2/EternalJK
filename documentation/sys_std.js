  ...
  for (let i = 0; i < exports.length; i++) {
    if (typeof window.Module.exports[exports[i]] == 'function'
      ...
      //if(window.Module.table.get(funcI)) {
        window[exports[i]] = window.Module.exports[exports[i]] //window.Module.table.get(funcI)
      //}
    }
  }

  //Z_Malloc = window.Module.table.get(HEAPU32[window.Module.addressOfZMalloc>>2])
}
