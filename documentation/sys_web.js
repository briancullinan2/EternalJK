...
function Sys_UnloadDll() {
	// TODO: delete some memory variables

	// garbage collect?
}

function Sys_LoadLegacyGameDll() {
	// TODO retrieve a function call after LoadLibrary

	// TODO call back into game system where it left off
}

function Sys_LoadGameDll() {
	// TODO retrieve a function call after LoadLibrary

	// TODO call back into game system where it left off
}

function GetBotLibAPI() {
...
const SYS = {
	...
	Sys_LoadGameDll: Sys_LoadGameDll,
	Sys_LoadLegacyGameDll: Sys_LoadLegacyGameDll,
	Sys_LoadDll: Sys_LoadLibrary,
	Sys_UnLoadDll: Sys_UnloadLibrary,
