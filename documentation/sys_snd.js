...
let SND = {
  ...
  S_StartSound: S_Base_StartSound,
  S_Base_StartSound: S_Base_StartSound,
  S_StartLocalSound: S_Base_StartLocalSound,
  S_Base_StartLocalSound: S_Base_StartLocalSound,
  S_AddLoopingSound: S_Base_AddLoopingSound,
  S_Base_AddLoopingSound: S_Base_AddLoopingSound,
  S_Base_AddRealLoopingSound: S_Base_AddLoopingSound,
  S_StopLoopingSound: S_Base_StopLoopingSound,
  S_Base_StopLoopingSound: S_Base_StopLoopingSound,

  S_StartAmbientSound: S_StartAmbientSound,
  S_AddAmbientLoopingSound: S_AddAmbientLoopingSound,
  S_ClearLoopingSounds: S_Base_ClearLoopingSounds,
  S_Base_ClearLoopingSounds: S_Base_ClearLoopingSounds,
  S_Base_ClearSoundBuffer: S_Base_ClearLoopingSounds,
  S_StopAllSounds: S_Base_ClearLoopingSounds,
  S_Base_StopAllSounds: S_Base_ClearLoopingSounds,
  S_DisableSounds: S_Base_ClearLoopingSounds,

  S_StartBackgroundTrack: S_Base_StopBackgroundTrack,
  S_StopBackgroundTrack: S_Base_StopBackgroundTrack,
  S_Base_StopBackgroundTrack: S_Base_StopBackgroundTrack,
  S_RawSamples: S_RawSamples,
  S_Base_Respatialize: S_Base_Respatialize,
  S_UpdateEntityPosition: S_Base_UpdateEntityPosition,
  ...
  SND_FreeOldestSound: SND_FreeOldestSound,
  S_MuteSound: S_MuteSound,
  S_Respatialize: S_Respatialize,
}


function S_Respatialize() {
  // not needed with stereos and update entity position?
}


function S_MuteSound() {

}


function SND_FreeOldestSound() {

}


function SND_RegisterAudio_LevelLoadEnd() {

}

function S_ClearSoundBuffer() {
